...
import { Container, Grid, ActionIcon, Button, Group } from '@mantine/core';
...
import { getAdvanceReports, getReportStateOptions } from '../lib/utilities';
import { v4 as uuidv4 } from 'uuid';
const ref: string = uuidv4()
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const CustomComponent = (props: any) => {

  return <ActionIcon variant="subtle" component='a' href={`#advance-reports/${props.data.id}`}>
    <IconEye style={{ width: '70%', height: '70%' }} stroke={1.5} />
  </ActionIcon>
};

export function AdvanceReports() {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  ...
  const q1 = useQuery({
    queryKey: [`advance-reports-${ref}`], queryFn: async () => {
  ...
  useEffect(() => {
    ...
    if (q2.data) {
      ...
      setColDefs([
        ...
        { field: "payment_ref", headerName: "Payment Reference", filter: 'agTextColumnFilter', },
  ...
  return (
    <Container size="lg" >
      <Grid>
        <Grid.Col span={12}>Advance Reports</Grid.Col>
